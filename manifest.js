  ...
  courses: [
    {
      ...
      modules: [
        ...
        { id:"c1-m2", n:2, title:"Posicionamento e Luxo Silencioso",
          file:"c1-m2-posicionamento.html", status:"todo", vol:"low", min:60, secs:6, deps:["c2-m3"],
          desc:"Neurociência do preço, arquitetura de autoridade, território semântico e diferenciação por mecanismo.",
          was:"Curso 1 · Módulo 2" },
        { id:"c1-m3", n:3, title:"Oferta e Precificação",
          file:"c1-m3-oferta.html", status:"todo", vol:"low", min:55, secs:5, deps:["c1-m2"],
          desc:"Engenharia de oferta, ancoragem ética, escada de valor, LTV, CAC teto e payback.",
          was:"Curso 1 · Módulo 4" },
        { id:"c1-m4", n:4, title:"Meta Ads: Estrutura de Campanha",
          file:"c1-m4-meta-ads.html", status:"todo", vol:"high", min:90, secs:8, deps:["c2-m5","c3-m2"],
          desc:"Leilão, Advantage+, arquitetura para orçamento baixo, categoria especial, públicos e escala.",
          was:"Curso 1 · Módulo 8" },
        { id:"c1-m5", n:5, title:"WhatsApp: A Sala de Espera Digital",
          file:"c1-m5-whatsapp.html", status:"todo", vol:"low", min:65, secs:8, deps:["c2-m2"],
          desc:"SLA de resposta, script de qualificação, filtro de preço, cadência de follow-up e CRM mínimo.",
    ...
    },
    {
      ...
      modules: [
        ...
        { id:"c2-m2", n:2, title:"Psicologia da Identificação",
          file:"c2-m2-identificacao.html", status:"todo", vol:"low", min:85, secs:12, deps:["c2-m1"],
          draft:"~40% redigido (seções 2.1–2.7) fora da plataforma. Primeira tarefa da Fase 1: terminar e montar.",
        ...
        { id:"c2-m4", n:4, title:"Engenharia dos Reels",
          file:"c2-m4-reels.html", status:"todo", vol:"med", min:95, secs:13, deps:["c2-m1","c2-m3"],
        ...
        { id:"c2-m5", n:5, title:"Biblioteca de Ganchos",
          file:"c2-m5-ganchos.html", status:"todo", vol:"low", min:110, secs:16, deps:["c2-m1","c2-m2"],
          desc:"52 estruturas × 4 exemplos = 208 aberturas, com mecanismo, quando falha e risco de política.",
          was:"Curso 2 · Módulo 5" },
        { id:"c2-m6", n:6, title:"Engenharia dos Roteiros",
          file:"c2-m6-roteiros.html", status:"todo", vol:"low", min:90, secs:11, deps:["c2-m5"],
          desc:"Contexto → Conflito → Explicação → Educação → Caminho → Convite. 24 roteiros completos.",
          was:"Curso 2 · Módulo 6" },
        { id:"c2-m7", n:7, title:"Instagram 2026",
          file:"c2-m7-instagram.html", status:"todo", vol:"high", min:75, secs:10, deps:["c2-m4"],
          desc:"Sistemas de ranqueamento, sinais declarados vs folclore, métricas e calendário orientado por dados.",
          was:"Curso 2 · Módulo 7" },
        { id:"c2-m8", n:8, title:"Planejamento de Conteúdo",
          file:"c2-m8-planejamento.html", status:"todo", vol:"low", min:95, secs:11, deps:["c2-m6","c2-m7"],
          desc:"Distribuição por pilar, calendário de 90 dias e os 5 checklists de produção.",
          was:"Curso 2 · Módulo 8" },
        { id:"c2-m9", n:9, title:"Erros Fatais (100)",
          file:"c2-m9-erros.html", status:"todo", vol:"med", min:110, secs:11, deps:["c2-m8"],
          desc:"100 erros em 9 categorias, com auditoria filtrável por severidade.",
          was:"Curso 2 · Módulo 9" }
      ]
    },
    {
      id: "c3", n: 3,
